...
Eigen::VectorXd KF::calculateError(Eigen::VectorXd estimateStates, Eigen::VectorXd measurements)
{
    Eigen::VectorXd results = Eigen::VectorXd::Zero(2);
